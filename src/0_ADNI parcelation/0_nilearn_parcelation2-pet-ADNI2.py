...
subjs = pd.read_csv('../../data/ADNI/CN/FDG_BASELINE_HEALTHY_4_15_2021_unique.csv')
subjs_list = subjs['Subject'].tolist()
# data_path = '/home/doeringe/Dokumente/projects/brain age/ADNI/MCI/2_SUVR_foranalysis/'
data_path = '/media/ukwissarchive/doeringe/BrainAge/ADNI/ADNI_safetycopy/CN/2_SUVR/'
