...
data <- read.csv('C:/Users/doeringe/Documents/BrainAge/PET_MRI_age/data/merged/test_train_PET_42.csv')
...
write.csv(df, "C:/Users/doeringe/Documents/BrainAge/PET_MRI_age/data/merged/test_train_PET_42_NP.csv", row.names = FALSE)
